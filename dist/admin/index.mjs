...
const RemoteSelectInputIcon = () => /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "33", height: "25", fill: "none", viewBox: "0 0 33 25", children: [
  /* @__PURE__ */ jsx(
    "path",
    {
      fill: "#80CBC4",
  ...
  app.customFields.register({
    ...
    components: {
      Input: async () => import(
        ...
        "../_chunks/RemoteSelect-BECDWkCk.mjs"
      )
    },
    options: getRemoteSelectRegisterOptions("base")
  });
}
const SearchableRemoteSelectIcon = () => /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "33", height: "25", fill: "none", viewBox: "0 0 33 25", children: [
  /* @__PURE__ */ jsx(
    "path",
    {
      fill: "#80CBC4",
...
function registerSearchableRemoteSelect(app) {
  app.customFields.register({
    ...
    components: {
      Input: async () => import(
        /* webpackChunkName: "RemoteSelect" */
        "../_chunks/SearchableRemoteSelect-BsMcNOAw.mjs"
      )
    },
